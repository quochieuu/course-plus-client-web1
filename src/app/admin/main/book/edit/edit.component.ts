...
export class EditComponent implements OnInit {
  ...
  submitCreateImage() {
    ...
    this.bookService.createImage(this.id, formData).subscribe(res => {
      console.log(res)
      this.getData();
      this.ngZone.run(() =>
      this.router.navigateByUrl('admin/book/update/'+this.id)
    );
    }, (err) => {
      this.getData();
      this.ngZone.run(() =>
    ...
    swalWithBootstrapButtons
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          this.bookService.update(this.id, this.item).subscribe(
            () => {
              this.ngZone.run(() =>
